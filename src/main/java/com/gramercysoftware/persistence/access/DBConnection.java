...
public class DBConnection implements java.sql.Connection {
    ...
    private boolean useOwnListeners = true;
    ...
    private void init(java.sql.Connection c, boolean readOnly, long maxLeaseTime)
    	throws SQLException {
    ...
    public DBConnection(java.sql.Connection c) throws SQLException {

    	init(c, false, DatabasePool.DEFAULT_MAX_LEASE);
    	useOwnListeners = false;
    }


    public DBConnection(java.sql.Connection c, boolean readOnly) throws SQLException{
     ...
     * @param c
     * @param readOnly
     * @param maxLeaseTime  maximum lease time of this connection in milliseconds
     * @throws SQLException
     */
    public DBConnection(java.sql.Connection c, boolean readOnly,
                        long maxLeaseTime) throws SQLException {
    ...
    public void commit() throws SQLException {
        if ( !readOnly ) {
            ...
            if (useOwnListeners) {
            	...
            	getManager().callCommitListeners();
            }
        }
    }
    ...
    public void rollback() throws SQLException {
        ...
        if (useOwnListeners) {
        	...
        	getManager().callRollBackListeners();
        }
    }
